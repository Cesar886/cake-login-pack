...
<body>
  <form id="f" autocomplete="on">
    ...
    <label>Email</label>
    <input name="email" type="email" required placeholder="demo@site.com" value="demo@site.com" />
    <label>Contraseña</label>
    <input name="password" type="password" required placeholder="123456" value="123456" />
